<?php
    ...
    */
    ...
    if(!isset($data->code)){
        $validations['code'] = 'Please enter code';
    }
    ...
    if($item->Login()){
        ...
        echo json_encode(array("error" => false, "message" => "User logged in successfully.", 'data' => array()), JSON_PRETTY_PRINT);
    } else{
        http_response_code(500);
        $msg = ($item->msg != '') ? $item->msg : "Incorrect Details. Please try again";
